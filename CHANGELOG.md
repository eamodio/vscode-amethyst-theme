...
- Increases the contrast of the menus for dark themes
...
- Adds diff editor border and missing fill colors to all the themes

### Fixed

- Fixes quick input focus color with VS Code 1.54

## [4.2.0] - 2021-02-08

### Added

- Adds editor ruler colors to all the themes
...
- Fixes panel header sections

## [4.0.3] - 2020-09-15

### Changed

- Increases the brightness of the hover widget border in the **Amethyst Dark** and **Amethyst Dark (Higher Contrast)** themes

## [4.0.2] - 2020-06-15

### Added

- Adds a border drop color for the panel

### Fixed

- Fixes notification border color

## [4.0.1] - 2020-06-03

### Fixed

- Fixes broken image in the README
...
- Adds support for the new breadcrumbs

### Changed

- Updates to latest built-in dark theme defaults
...
- Fixes issue with empty editor background color

## [2.0.7] - 2018-07-17

### Added

- Adds support for custom titlebar menu theming
